namespace AppDev.Migrations
{
    ...
    public partial class AddDbCoursesAndCategories : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        Name = c.String(),
                        Description = c.String(),
                        Categogy_Id = c.String(maxLength: 128),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Categories", t => t.Categogy_Id)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Courses", "Categogy_Id", "dbo.Categories");
            ...
            DropIndex("dbo.Courses", new[] { "Categogy_Id" });
